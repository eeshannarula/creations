class ImageClassifier {
  constructor(classes) {
    ...
    this.oneSide = 50;
    this.GREYlen = 2500 //this.oneSide * this.oneSide;
    this.RGBlen = 10000 //this.GREYlen * 4;
  }
  //============================================================================
  ...
  static async loadModel(jsonUpload, weightsUpload) {
...
//   }
//   //add to both training and testing:
//   addToBoth(data, label) {
//     for (var i = 0; i < data.length; i++) {
//       let offset = i * this.params.offset;
//       let threshold = floor(0.8 * data.length);
//       let img = [];
//       for (var j = 0; j < this.params.offset; j++) {
//         img[j] = data.bytes[offset + j] / 255;
//       }
//       if (i < threshold) {
//         this.data.trainingdata.push(img);
//         this.data.traininglabels.push(label);
//
//       } else {
//         this.data.testingdata.push(img);
//         this.data.testinglabels.push(label);
//       }
//     }
//   }
